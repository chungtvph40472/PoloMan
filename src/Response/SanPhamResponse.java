...
public class SanPhamResponse {
    ...
    public SanPhamResponse(int idSanPham, int idSanPhamCT, int idThuongHieu, String tenThuongHieu, String maSanPham, String tenSanPham, String tenSanPhamCT, int soLuong, int trangThai, int trangThaiCT) {
