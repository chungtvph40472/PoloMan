...
public class ViewVoucher extends javax.swing.JPanel {
    ...
    private void showDataTable(ArrayList<Voucher> lists) {
        ...
        lists.forEach(s -> dtm.addRow(new Object[]{
            index++, s.getTenVocher(), s.getMoTa(), s.getPhanTramGiamGia(), s.getNgayBatDau(), s.getNgayKetThuc(), s.getTrangThai() == 1 ? "Còn Hạn" : "Hết Hạn"
        }));
    }
    ...
    private void detailVocher(int index) {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        txtNameVoucher.setText(vc.getTenVocher());
    ...
    private Voucher getFormData() {
        ...
        Voucher vc = Voucher.builder()
                .tenVocher(txtNameVoucher.getText())
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            Voucher vc = new Voucher();
            vc.setTenVocher(txtNameVoucher.getText().trim());
